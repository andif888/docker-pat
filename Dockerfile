...
ENV TF_PROVIDER_LOCAL_VERSION=2.9.0
ENV TF_PROVIDER_NULL_VERSION=3.3.0
ENV TF_PROVIDER_TLS_VERSION=4.3.0
ENV TF_PROVIDER_VAULT_VERSION=5.9.0
ENV TF_PROVIDER_VSPHERE_VERSION=2.12.0
ENV TF_PROVIDER_CITRIX_VERSION=1.0.35
